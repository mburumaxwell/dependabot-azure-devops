...
export async function GET(_req: Request, params: RouteContext<'/dashboard/settings/billing/success/[id]'>) {
  ...
  return Response.redirect(`${config.siteUrl}/dashboard/settings/billing`, 302);
}
